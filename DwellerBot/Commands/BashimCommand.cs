...
namespace DwellerBot.Commands
{
    class BashimCommand:CommandBase
    {
        ...
        public override async Task ExecuteAsync(Update update, Dictionary<string, string> parsedMessage)
        {
            ...
            await Bot.SendTextMessageAsync(update.Message.Chat.Id, HttpUtility.HtmlDecode(result), Telegram.Bot.Types.Enums.ParseMode.Default, false, false, update.Message.MessageId);
        }
